...
@section('content')
    ...
    <h2 class="page-title mb-4">
        <a href="{{ route('admin.laboran.alat.index') }}" class="breadcrumb-link">Labotarium</a> > Lihat Alat Lab
    </h2>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_alat" value="{{ $alat->nama_alat ?? 'Nama Alat' }}"
                        readonly>
                </div>

                <div class="mb-3">
                    <label for="id_alat" class="form-label">ID Alat</label>
                    <input type="text" class="form-control" id="id_alat" value="{{ $alat->id_alat ?? 'ID-001' }}"
                        readonly>
                </div>
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kualitas" value="{{ $alat->kualitas ?? 'Baik' }}"
                        readonly>
                </div>

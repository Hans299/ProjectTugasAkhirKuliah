...
@push('styles')
    <style>
        ...
        .action-buttons .btn {
            ...
            border-radius: 8px;
            margin: 0 2px;
            /* Memberi sedikit jarak antar tombol */
        }
    </style>
@endpush
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="{{ route('admin.laboran.alat.create') }}" class="btn btn-primary"
                style="background-color: #25256C; border: none; padding: 0.5rem 1rem; font-weight: 600;">
            ...
            <div class="search-bar" style="max-width: 400px;">
                <form method="GET" id="search-form">
                    <input type="text" name="search" id="search-input" value="{{ request('search') }}"
                        class="form-control" placeholder="Cari Alat Lab" autocomplete="off">
                </form>
                    ...
                    @forelse($alats as $alat)
                        <tr>
                            ...
                            <td class="action-buttons">
                                ...
                                <a href="{{ route('admin.laboran.alat.edit', $alat->id) }}"
                                    class="btn btn-warning text-white">
                                    <i class="fa fa-pencil-alt"></i>
                                </a>

                                {{-- Tombol Hapus (DIPERBAIKI) --}}
                                <form action="{{ route('admin.laboran.alat.destroy', $alat->id) }}" method="POST"
                                ...
                                <a href="{{ route('admin.laboran.alat.show', $alat->id) }}" class="btn btn-info text-white">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </td>
                        </tr>

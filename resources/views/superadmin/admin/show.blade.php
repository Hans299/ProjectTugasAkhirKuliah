...
@section('content')
    ...
    <h2 class="page-title mb-4">
        <a href="{{ route('admin.superadmin.admin.index') }}" class="breadcrumb-link">Data Admin</a> > Lihat Admin
    </h2>
    ...
    <div class="form-card">
        <div class="mb-3 d-flex flex-column align-items-center">
            @if ($admin->profile_photo_path)
                <img src="{{ asset('storage/' . $admin->profile_photo_path) }}" alt="Foto Profil" class="current-image">
            @else
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" value="{{ $admin->email ?? 'Email Admin' }}"
                        readonly>
                </div>

                <div class="mb-3">
                    <label for="username" class="form-label">Username</label>
                    <input type="text" class="form-control" id="username" value="{{ $admin->name ?? 'Username Admin' }}"
                        readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="role"
                        value="{{ ucfirst($admin->role->name ?? 'Role') }}" readonly>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <small class="text-muted">Password tidak dapat ditampilkan</small>
                    <div class="div">
                        <a href="{{ route('admin.superadmin.admin.edit', $admin->id) }}"
                            class="btn btn-secondary btn-sm mt-2">Klik
                            Untuk Ubah Password</a>
                    </div>
                </div>

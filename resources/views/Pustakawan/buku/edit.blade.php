...
@section('content')
    ...
    <h2 class="page-title mb-4">
        <a href="{{ route('admin.pustakawan.buku.index') }}" class="breadcrumb-link">Perpustakaan</a> > Edit Buku
    </h2>
    ...
    <div class="form-card">
        <div class="mb-3  d-flex flex-column align-items-center">
            @if ($buku->gambar)
                <img src="{{ asset('storage/' . $buku->gambar) }}" alt="Buku" class="current-image d-block">
            @else
        ...
        <form action="{{ route('admin.pustakawan.buku.update', $buku->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="judul_buku" name="judul_buku"
                            placeholder="Masukan Judul Buku" value="{{ old('judul_buku', $buku->judul_buku) }}" required>
                        @error('judul_buku')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="penerbit" name="penerbit"
                            placeholder="Masukan Penerbit" value="{{ old('penerbit', $buku->penerbit) }}">
                        @error('penerbit')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="tahun_terbit" name="tahun_terbit"
                            placeholder="Masukan Tahun Terbit (Contoh: 2024)"
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="stok" name="stok"
                            placeholder="Masukan Stok Buku" value="{{ old('stok', $buku->stok) }}" required>
                        @error('stok')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="penulis" name="penulis"
                            placeholder="Masukan Penulis" value="{{ old('penulis', $buku->penulis) }}">
                        @error('penulis')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="halaman" name="halaman"
                            placeholder="Masukan Halaman" value="{{ old('halaman', $buku->halaman) }}">
                        @error('halaman')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="kategori" name="kategori" required>
                            ...
                            <option value="Buku Umum"
                                {{ old('kategori', $buku->kategori) == 'Buku Umum' ? 'selected' : '' }}>Buku Umum</option>
                            <option value="Buku Mata Pelajaran"
                                {{ old('kategori', $buku->kategori) == 'Buku Mata Pelajaran' ? 'selected' : '' }}>Buku Mata
                                Pelajaran</option>
                        </select>
                        @error('kategori')
                            <div class="text-danger mt-1">{{ $message }}</div>

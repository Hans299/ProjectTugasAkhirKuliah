...
@section('content')
    ...
    <h2 class="page-title mb-4">
        <a href="{{ route('admin.pustakawan.buku.index') }}" class="breadcrumb-link">Perpustakaan</a> > Lihat Buku
    </h2>
    ...
    <div class="form-card">
        <div class="mb-3  d-flex flex-column align-items-center">
            @if ($buku->gambar)
                <img src="{{ asset('storage/' . $buku->gambar) }}" alt="Foto Profil" class="current-image d-block">
            @else
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="judul_buku"
                        value="{{ $buku->judul_buku ?? 'Judul Buku' }}" readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="penerbit" value="{{ $buku->penerbit ?? 'Penerbit' }}"
                        readonly>
                </div>

                <div class="mb-3">
                    <label for="tahun_terbit" class="form-label">Tahun Terbit</label>
                    <input type="number" class="form-control" id="tahun_terbit" value="{{ $buku->tahun_terbit ?? 2024 }}"
                        readonly>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="penulis" value="{{ $buku->penulis ?? 'Penulis' }}"
                        readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kategori" value="{{ $buku->kategori ?? 'Kategori' }}"
                        readonly>
                </div>
            </div>

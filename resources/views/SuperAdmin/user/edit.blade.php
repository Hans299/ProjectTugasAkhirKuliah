...
@section('content')
    ...
    <h2 class="page-title mb-4">
        <a href="{{ route('superadmin.pengguna.index') }}" class="breadcrumb-link">Data User</a> > Edit User
    </h2>
    ...
    <div class="form-card">
        ...
        --}}
        <form action="{{ route('superadmin.pengguna.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        {{-- 'value' diisi dengan data lama dari $user --}}
                        <input type="email" class="form-control" id="email" name="email" placeholder="Masukan Email" value="{{ old('email', $user->email) }}" required>
                    </div>

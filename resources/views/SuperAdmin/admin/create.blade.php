...
<style>
    ...
    .page-title .breadcrumb-link {
        color: #6c757d; /* Warna abu-abu untuk link "Data Admin" */
...
@section('content')
    ...
    <h2 class="page-title mb-4">
        <a href="{{ route('superadmin.admins.index') }}" class="breadcrumb-link">Data Admin</a> > Tambah Admin
    </h2>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="username" name="name" placeholder="Masukan Username" value="{{ old('name') }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="role" name="role" required>
                            ...
                            <option value="pustakawan" {{ old('role') == 'pustakawan' ? 'selected' : '' }}>Perpustakaan</option>
                            <option value="laboran" {{ old('role') == 'laboran' ? 'selected' : '' }}>Lab</option>
                        </select>
                    </div>
                </div>

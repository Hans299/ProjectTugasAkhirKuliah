                        ...
                        <form action="{{ route('register') }}" method="POST" class="text-start">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-3" id="name" name="name"
                                    placeholder="Masukan Username" value="{{ old('name') }}" required autofocus>
                            </div>
                            ...
                            {{-- Form Group Kelas --}}
                            <div class="mb-3">
                                <label for="kelas" class="form-label ms-1">Kelas:</label>
                                <input type="text" class="form-control rounded-3" id="kelas" name="kelas"
                                    placeholder="Masukan Kelas" value="{{ old('kelas') }}" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control rounded-start-3" id="password_confirmation"

...
<style>
    ...
    .page-title .breadcrumb-link {
        color: #6c757d; /* Warna abu-abu untuk link "Labotarium" */
...
@section('content')
    ...
    <h2 class="page-title mb-4">
        <a href="{{ route('laboran.alat.index') }}" class="breadcrumb-link">Labotarium</a> > Tambah Alat Lab
    </h2>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_alat" name="nama_alat" placeholder="Masukan Nama Alat" value="{{ old('nama_alat') }}" required>
                    </div>
                    
                    <div class="mb-3">
                        <label for="id_alat" class="form-label">ID Alat</label>
                        <input type="text" class="form-control" id="id_alat" name="id_alat" placeholder="Masukan ID Alat" value="{{ old('id_alat') }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="stok" class="form-label">Stok Alat</label>
                        <input type="number" class="form-control" id="stok" name="stok" placeholder="Masukan Stok Alat" value="{{ old('stok') }}" required>
                    </div>
                </div>
